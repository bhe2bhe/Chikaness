...
class Blog(models.Model):
    ...
    image = models.ImageField(default='blog-default.jpeg', upload_to='blog_pics')
    ...
    image2_caption = models.CharField(max_length=255, blank=True, default="Photo has no caption")
    image3_caption = models.CharField(max_length=255, blank=True, default="Photo has no caption")
    image4_caption = models.CharField(max_length=255, blank=True, default="Photo has no caption")
    image5_caption = models.CharField(max_length=255, blank=True, default="Photo has no caption")
    image6_caption = models.CharField(max_length=255, blank=True, default="Photo has no caption")
    image7_caption = models.CharField(max_length=255, blank=True, default="Photo has no caption")
    image8_caption = models.CharField(max_length=255, blank=True, default="Photo has no caption")
    image9_caption = models.CharField(max_length=255, blank=True, default="Photo has no caption")
